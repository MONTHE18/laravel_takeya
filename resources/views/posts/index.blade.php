<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="overflow-hidden bg-white rounded-md border p-5 shadow mb-4">
    <h3>
    ...
    <div class="mt-4 flex justify-between">
        ...
        <div class="flex gap-2 items-center">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="size-4 fill-gray-500">
                <path d="M256 8C119 8 8 119 8 256S119 504 256 504 504 393 504 256 
                    393 8 256 8zm92.5 313h0l-20 25a16 16 0 0 1 -22.5 2.5h0l-67-49.7a40 40 0 0 1 
                    -15-31.2V112a16 16 0 0 1 16-16h32a16 16 0 0 1 16 16V256l58 
                    42.5A16 16 0 0 1 348.5 321z"/>
            </svg>
